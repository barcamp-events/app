...
export class UpcomingBarcamps {
  ...
  render() {
    return <Host>
        <stellar-layout class="bb b--theme-base2 dm-b--theme-base7" padding="large">
          <copy-wrap align="center">
            <h2 class="parco">Upcoming BarCamp Events</h2>
        </copy-wrap>
        {this.conferences && this.conferences.map(conf => <div class="bt bb pa2 b--theme-base5 flex flex-column flex-row-m flex-row-l space-between items-center">
          <div class="w-100">
