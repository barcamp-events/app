import { Component, Host, h, State, Element, forceUpdate } from "@stencil/core";
          ...
          <midwest-layout size="tiny">
            ...
            >
              <header class="text-center overflow-hidden">
                <h2 class="parco i text-base-12 dm:text-base-4">
                  Edit your Profile
                </h2>
              </header>
              <section>
                ...
                <section slot="back" class="flex items-center justify-center">
                  <copy-wrap align="center" class="-mt-12">
                    <midwest-avatar
                      ...
                      shape="circle"
                    />
                    <h4 class="parco text-base-6 dm:text-base-6">
